    ...
    <div class="container">
        <div class = "panel panel-default">
            <div class="panel-heading">
                <h2>Action Center Admin Informations {{$acmun}}</h2>
            </div>
            <div class="panel-body">
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                   ...
                   <tbody>
                   @foreach($alerts as $ac)
                       <tr class="odd gradeX">
                           <td class="center">{{$ac->fname}} {{$ac->mname}} {{$ac->lname}}</td>
                          {{-- <td class="center">{{$ac->name}}</td>--}}
                           <td class="center">{{$ac->alert_type}}</td>
                           <td class="center">{{$ac->time}}</td>
                           <td class="center">{{$ac->end_time}}</td>
